...
function main()
{
    ...
    try 
    {
        $create_backup_dir = New-Item -Type Directory -Path $backup_directory -Verbose:$false
    }
    catch 
    {
    ...
    try 
    {
        ...
        Write-Host -ForegroundColor Yellow "[*] This script will close automatically upon completion "
        
        Copy-Item -Path C:\Users\$env:USERNAME -Destination $backup_directory -Force -Recurse -Verbose:$false
