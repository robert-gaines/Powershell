...
function main()
{
    ...
    Get-ADComputer -SearchBase $searchBase -Filter * -Properties * | Foreach-Object {
                                                                                       ...
                                                                                       if(($version_str.Substring(0,3) -notcontains '10.') -and !($os_version -eq $null) -and ($version_str.Substring(0,3) -notcontains '6.3') -and ($version_str.Substring(0,3) -notcontains '5.1'))
                                                                                       {
                                                                                        if(!($os_system | Select-String -Pattern 'Server'))
                                                                                        {
