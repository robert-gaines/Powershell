...
supports your ability to sign into your computer will expire in $days_remaining days. Please
...
The Finance & Administration Information Systems Team
    ...
    try
    {
        Send-MailMessage -From 'fais@wsu.edu' -To $addr -Subject "Expiration of Cached Credentials" -Body $body -SmtpServer smtp.wsu.edu          
    }
    catch
    {
        return
